...
import 'aerobic.crud1.view.dart';

class AerobicCrudView extends StatefulWidget {

  @override
  _AerobicCrudView createState() => _AerobicCrudView();
}

class _AerobicCrudView extends State<AerobicCrudView> {
              ...
              child: SizedBox.expand(
                child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AerobicCrud1View()),
                    );
                  },
                ),
              ),
