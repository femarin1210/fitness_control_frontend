...
import 'aerobic.crud2.view.dart';

class AerobicCrud1View extends StatefulWidget {

  @override
  _AerobicCrud1View createState() => _AerobicCrud1View();
}

class _AerobicCrud1View extends State<AerobicCrud1View> {
              ...
              child: SizedBox.expand(
                child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AerobicCrud2View()),
                    );
                  },
                ),
              ),
