...
class SupplementView extends StatefulWidget {
  ...
  @override
  _SupplementView createState() => _SupplementView();
}

class _SupplementView extends State<SupplementView> {
            ...
            children: <Widget>[
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("07:30 - 1 Cápsula Cloreto de Magnésio",
                      style: TextStyle(
                        fontSize: 14,
