...
class WorkoutSequenceExerciseView extends StatefulWidget {

  @override
  _WorkoutSequenceExerciseView createState() => _WorkoutSequenceExerciseView();
}

class _WorkoutSequenceExerciseView extends State<WorkoutSequenceExerciseView> {
